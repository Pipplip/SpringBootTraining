package de.phbe.springboottraining.core.profile;

import com.fasterxml.jackson.annotation.JsonIgnore;
import de.phbe.springboottraining.core.photo.Photo;
...
@Entity
@Access( AccessType.FIELD ) // JPA soll direkt auf die Felder zugreifen, nicht über die Getter/Setter. ansonsten müsste @Id beim Getter stehen
public class Profile {
    ...
    */
    ...
    @Column(name = "attracted_to_gender") // hier kann man manuell angeben, wie die spalte in der db heissen soll
